        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-[#2D1B1B] leading-relaxed">
              <p>I am a Computer Science graduate and Data professional specializing in building end-to-end solutions that turn complex data into actionable business strategies. ✨</p>

              <p>By combining a strong academic foundation in Informatics with hands-on experience in SQL, Python, Tableau, and Looker , I transform raw data into compelling stories that drive strategic decisions.</p>
